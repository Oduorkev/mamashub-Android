...
class MeaslesImmunizationDetailsAdapter(
    private val detailsList: List<Detail>
) : RecyclerView.Adapter<MeaslesImmunizationDetailsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_measles_immunization_detail, parent, false)
