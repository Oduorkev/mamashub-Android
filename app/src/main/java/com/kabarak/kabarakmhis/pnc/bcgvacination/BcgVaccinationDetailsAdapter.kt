...
class BcgVaccinationDetailsAdapter(
    private val detailsList: List<Detail>
) : RecyclerView.Adapter<BcgVaccinationDetailsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_bcg_vaccination_detail, parent, false)
