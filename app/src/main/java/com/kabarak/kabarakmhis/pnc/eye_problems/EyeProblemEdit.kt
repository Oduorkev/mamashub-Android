...
class EyeProblemEdit : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionnaireJsonString = getStringFromAssets("eye_problems.json")
        ...
        supportFragmentManager.setFragmentResultListener(
            ...
            Log.d("EyeProblemEdit", "Submit request received")
    ...
    private fun getStringFromAssets(fileName: String): String? {
        return try {
            ...
            Log.e("EyeProblemEdit", "Error loading JSON from assets", e)
            null
        }
    }
                    ...
                    response.body()?.string()?.let { jsonResponse ->
                        CoroutineScope(Dispatchers.Main).launch {
                            try {
                                ...
                                Log.e("EyeProblemEdit", "Error parsing and populating questionnaire", e)
                                Toast.makeText(this@EyeProblemEdit, "Failed to parse response", Toast.LENGTH_SHORT).show()
                            }
                        }
                    } ?: run {
    ...
    private fun populateQuestionnaireFragment(questionnaireResponse: QuestionnaireResponse) {
        try {
            ...
            Log.d("EyeProblemEdit", "Questionnaire populated successfully")
        } catch (e: Exception) {
            Log.e("EyeProblemEdit", "Error loading questionnaire with response", e)
    ...
    private fun submitUpdatedResponse() {
        ...
        updatedQuestionnaireResponse?.let {
            ...
            Log.d("EyeProblemEdit", "Submitting: $updatedResponseJson")
